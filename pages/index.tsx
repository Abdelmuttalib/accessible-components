        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="mt-4">
                    <p className="text-base text-gray-500">
                      ...
                      Magni accusantium labore molestiae aut illo? Dolore
                      voluptatum.
                    </p>
                  </div>
